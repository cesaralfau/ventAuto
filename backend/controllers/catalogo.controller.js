...
exports.create = (req, res) => {
    ...
    const item_ = new Item({
        ...
        color_catal: catalInfo.color_catal,
        estado_catal: catalInfo.estado_catal,
        id_marcamodelo: catalInfo.modelo,
        id_user: catalInfo.id_user,
        inter_catal: catalInfo.inter_catal,
        precio_catal: catalInfo.precio_catal,
        trans_catal: catalInfo.trans_catal,

    });

    // // Save Item in the database
    Item.create(item_, filesInfo, (err, data) => {
        if (err)
            res.status(500).send({
