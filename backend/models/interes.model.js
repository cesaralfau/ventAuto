...
const Item = function(item_) {
    this.id_catal = req.body.id_catal,
        this.id_user = req.body.id_user,
        this.nombre_no_registrado = req.body.nombre_no_registrado,
        this.correo_no_registrado = req.body.correo_no_registrado,
        this.telef_no_registrado = req.body.telef_no_registrado
